...
<template>
	<v3-row justify="center" :gutter="20">
		...
		<v3-col>
			<v3-tooltip content="上右" placement="top-end" v-model="state.showTopEnd">
	...
	<v3-row justify="space-between" :gutter="20">
		<v3-col :span="6">
			<v3-row justify="space-around" :gutter="20">
				...
				<v3-col style="margin-top: 20px" :span="12">
					<v3-tooltip content="左中" placement="left" v-model="state.showLeft">
		...
		<v3-col :span="6">
			<v3-row style="text-align: right;" justify="space-between" :gutter="20">
				<v3-col :span="12">
					<v3-tooltip
						content="右上"
	...
	<v3-row justify="center" :gutter="20">
		...
		<v3-col>
			<v3-tooltip content="下中" placement="bottom" v-model="state.showBottom">
...
> 其它参数同 [BasePopper](./base-popper.md)
