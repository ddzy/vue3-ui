import { V3Carousel, V3CarouselItem } from '@components/main';
...
describe('V3Carousel 组件测试：', () => {
	...
	test('V3Carousel 组件可以接收【defaultIndex】配置项，用来配置默认要显示的轮播图下标，优先级比【v-model】高', async () => {
		const wrapper = mount({
			components: {
				V3Carousel,
				V3CarouselItem,
	...
	test('V3Carousel 组件可以接收【effect】配置项，用来启用渐隐形式的轮播图', async () => {
		const wrapper = mount({
			components: {
				V3Carousel,
				V3CarouselItem,
	...
	test('V3Carousel 组件可以通过【slot=arrowLeft】、【slot=arrowRight】，来自定义切换箭头', async () => {
		const wrapper = mount({
			components: {
				V3Carousel,
				V3CarouselItem,
	...
	test('V3Carousel 组件可以接收【showArrow】配置项，用来配置箭头的显示时机', async () => {
		const wrapper = mount({
			components: {
				V3Carousel,
				V3CarouselItem,
	...
	test('V3Carousel 组件可以接收【duration、timingFunction】配置项，用来自定义切换时的过渡时间、过渡曲线', async () => {
		const wrapper = mount({
			components: {
				V3Carousel,
				V3CarouselItem,
	...
	test('V3Carousel 组件可以通过【slot=indicator】，来自定义导航按钮', async () => {
		const wrapper = mount({
			components: {
				V3Carousel,
				V3CarouselItem,
	...
	test('V3Carousel 组件可以接收【indicatorType】配置项，用来启用不同样式的导航按钮', async () => {
		const wrapper = mount({
			components: {
				V3Carousel,
				V3CarouselItem,
	...
	test('V3Carousel 组件可以接收【disabled】配置项，用来禁用轮播图', async () => {
		const wrapper = mount({
			components: {
				V3Carousel,
				V3CarouselItem,
	...
	test('V3Carousel 组件可以接收【indicatorPosition】配置项，用来配置导航按钮的摆放位置', async () => {
		const wrapper = mount({
			components: {
				V3Carousel,
				V3CarouselItem,
	...
	test('V3Carousel 组件可以接收【direction】配置项，用来启用垂直方向上的轮播图', async () => {
		const wrapper = mount({
			components: {
				V3Carousel,
				V3CarouselItem,
