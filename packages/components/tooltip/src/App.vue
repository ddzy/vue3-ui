<template>
	<div class="demo-container">
		...
		<v3-row>
			<v3-col :span="12">
				<h3>可通过 slot='content' 传入自定义内容：</h3>
			</v3-col>
			<v3-col>
				<v3-tooltip trigger="mouseenter">
		...
		<v3-row>
			...
			<v3-col>
				<v3-tooltip trigger="mouseenter" disabled>
					<v3-button plain>鼠标移上来</v3-button>
					<template #content>
		...
		<v3-row>
			<v3-col :span="12">
				<h3>自定义弹出菜单距离触发器的距离：</h3>
			</v3-col>
			<v3-col>
				<v3-tooltip trigger="mouseenter" :offset="[0, 20]">
					<v3-button plain>鼠标移上来</v3-button>
					<template #content>
						<p style="margin: 0; word-break: break-all">
							听过这样一句话，并不是每一条鱼，都生活在同一片海里。每个人都有自己的幸福阈值，如鱼饮水，冷暖自知。若用自己的经验随意去评价他人的生活，只会给彼此带来麻烦和困扰
